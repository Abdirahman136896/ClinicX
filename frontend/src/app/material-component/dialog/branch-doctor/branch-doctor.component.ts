...
@Component({
  selector: 'app-branch-doctor',
  templateUrl: './branch-doctor.component.html',
  styleUrls: ['./branch-doctor.component.scss']
})
export class BranchDoctorComponent implements OnInit {
  ...
  public dialogRef:MatDialogRef<BranchDoctorComponent>,
